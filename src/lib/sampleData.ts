...
export function resumeForGalleryPreview(live: Resume): Resume {
  ...
  return {
    ...
    theme: {
      ...
      typeSize: live.theme?.typeSize ?? demo.theme.typeSize,
      lineHeight: live.theme?.lineHeight ?? demo.theme.lineHeight,
      atsSafe: false,
...
export function createBlankResume(): Resume {
  ...
  return {
    ...
    contact: { fullName: "", title: "", phone: "", email: "", city: "", country: "", linkedin: "", website: "", github: "", portfolioUrl: "", photoUrl: "", socials: [] },
    summary: "",
    objective: "",
    useObjective: false,
    experience: [],
